        ...
        <v-row class="relative full-vh about-me-section">
            <div ref="projectSectionMask" class="project-section-mask">
                <div class="center-item">
                    <pulsating-dot @iconClicked="showProjects"></pulsating-dot>
                </div>
            </div>
            <v-col cols="12">
                <div class="projects-grid-container full-vh padding-0 relative">

                    <div ref="projectText" class="project-text">
                        <s-v-g-ellipse class="center-item" :id="'section-title-background'"></s-v-g-ellipse>
                        <s-v-g-projects class="center-item" :id="'section-title'"/>
                    </div>

                    <s-v-g-project-item elem-id="dkrHexLoader"
                                        :svg-style="getStyleForSvg('center')"
                                        :title="'DKRHexLoader'"
                                        :sub-text="'Simple script to add hex loader to page'"
                                        :link="'https://github.com/DawidRoguziak/DKRHexLoader'"></s-v-g-project-item>


                    <s-v-g-project-item elem-id="solScrapper"
                                        :svg-style="getStyleForSvg('flex-end') + 'cursor: not-allowed;'"
                                        :title="'SolScrapper'"
                                        :sub-text="'Work in progres'"></s-v-g-project-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initGsap() {
                this.timeline = this.$gsap.timeline({defaults: {ease: 'power4.inOut'}});
            ...
            showProjects() {
                this.timeline
                    .to(this.$refs.projectSectionMask, {opacity: 0, duration: 1.5, display: 'none'})
                    .to(this.$refs.projectText, {opacity: 1, duration: .5})
