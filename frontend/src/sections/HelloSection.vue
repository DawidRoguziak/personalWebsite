     ...
     <section id="hello">
          ...
          >
               <v-col
                    ...
                    md="6"
                    xl="6"
                    class="display-xs-none"
               >
                    <img
                         :src="image"
                         class="full-vh display-xs-none face-img"
                    />
               </v-col>
...
export default {
     ...
     computed: {
          ...
          rightTextDevWait() {
               return (
                    this.rightTextNameWait +
                    this.rightText.name.length * this.typeSpeed
               );
          },
