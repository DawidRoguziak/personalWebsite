        ...
        <v-col cols="12">
            <v-row class="full-vh about-me-section">
                <v-col :align="'center'" cols="12">
                    <svg id="bf987f75-b15a-4b7f-a137-75b4492c4a21" data-name="Layer 1"
                         xmlns="http://www.w3.org/2000/svg"
                         xmlns:xlink="http://www.w3.org/1999/xlink" width="1167.52" height="756.03"
                         viewBox="0 0 1167.52 756.03">
                        <defs>
                            <linearGradient id="b752362c-f89d-48d5-9dd1-266417fc8d3c" x1="588.17" y1="804.7" x2="588.17"
                                            y2="185.7"
                            ...
                            <linearGradient id="a11e32f9-0bc0-4cef-b66b-30dd4b707f0c" x1="567.7" y1="1179.83" x2="567.7"
                                            y2="1173.83"
                                            gradientTransform="translate(74.47 -1004.13)"
                                            xlink:href="#b752362c-f89d-48d5-9dd1-266417fc8d3c"/>
                            <linearGradient id="ada07a9a-e50a-4215-9506-0eaaef22308f" x1="588.52" y1="693.03"
                                            x2="588.52" y2="483.16"
                                            xlink:href="#b752362c-f89d-48d5-9dd1-266417fc8d3c"/>
                        </defs>
                        ...
                        <g opacity="0.2">
                            ...
                            <ellipse cx="1022.06" cy="778.26" rx="14.01" ry="10.7"
                                     transform="translate(-160.29 1245.24) rotate(-62.09)"
                                     fill="#3f3d56"/>
                            <ellipse cx="1030.07" cy="763.12" rx="14.01" ry="10.7"
                                     transform="translate(-142.65 1244.27) rotate(-62.09)"
                                     fill="#3f3d56"/>
                            <ellipse cx="1038.09" cy="747.99" rx="14.01" ry="10.7"
                                     transform="translate(-125.01 1243.3) rotate(-62.09)"
                                     fill="#3f3d56"/>
                            <ellipse cx="1046.11" cy="732.85" rx="14.01" ry="10.7"
                        ...
                        <g opacity="0.2">
                            <path d="M991.37,495.94a31.64,31.64,0,0,1-2.25,4.64q-15.11-8.06-30.61-15.66c.14-.43.3-.88.47-1.31a27.2,27.2,0,0,1,8.3-11.66c4.87-3.9,10.74-5.37,16-3.38s8.62,7,9.67,13.11A27.21,27.21,0,0,1,991.37,495.94Z"
                                  transform="translate(-16.24 -71.99)" fill="#3f3d56"/>
                            <ellipse cx="985.03" cy="463.85" rx="22.69" ry="17.33"
                                     transform="translate(184.88 1147.47) rotate(-69.16)"
                                     fill="#3f3d56"/>
                            <ellipse cx="994.89" cy="437.94" rx="22.69" ry="17.33"
                                     transform="translate(215.46 1139.99) rotate(-69.16)"
                                     fill="#3f3d56"/>
                            <ellipse cx="1004.76" cy="412.02" rx="22.69" ry="17.33"
                                     transform="translate(246.03 1132.51) rotate(-69.16)"
                                     fill="#3f3d56"/>
                            <ellipse cx="1014.62" cy="386.11" rx="22.69" ry="17.33"
                        ...
                        <g opacity="0.2">
                            <path d="M194.62,582.15a37.29,37.29,0,0,0,2,5.8q19-7.28,38.43-14c-.11-.53-.22-1.08-.36-1.62a32.41,32.41,0,0,0-8.07-15c-5.18-5.32-11.89-7.92-18.34-6.34s-11.2,7-13.35,14A32.49,32.49,0,0,0,194.62,582.15Z"
                                  transform="translate(-16.24 -71.99)" fill="#3f3d56"/>
                            <ellipse cx="206.83" cy="545.22" rx="20.61" ry="26.98"
                                     transform="translate(-139.61 -7.4) rotate(-13.72)"
                                     fill="#3f3d56"/>
                            <ellipse cx="199.01" cy="513.19" rx="20.61" ry="26.98"
                                     transform="translate(-132.24 -10.16) rotate(-13.72)"
                                     fill="#3f3d56"/>
                            <ellipse cx="191.2" cy="481.16" rx="20.61" ry="26.98"
                                     transform="translate(-124.87 -12.93) rotate(-13.72)"
                                     fill="#3f3d56"/>
                            <ellipse cx="183.38" cy="449.12" rx="20.61" ry="26.98"
